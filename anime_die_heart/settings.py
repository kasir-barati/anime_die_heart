"""
Django settings for anime_die_heart project.
...
SECRET_KEY = 'django-insecure-77hptzt_iz9g#0(5jxv&f%+@klssg@si()%3w)3#x@$$g$9n^u'
...
ROOT_URLCONF = 'anime_die_heart.urls'
...
WSGI_APPLICATION = 'anime_die_heart.wsgi.application'
